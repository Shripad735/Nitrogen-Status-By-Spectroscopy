...
class RFModel(BaseModel):
    ...
    def __cross_validate(self):
        ...
        plt.plot([i for i in range(1, 11)], self.cv_rmse['Avg_RMSE'], label='Multi Output PLSR')
        plt.plot([i for i in range(1, 11)], self.cv_rmse['N_Value'], label='N Value PLSR')
        plt.plot([i for i in range(1, 11)], self.cv_rmse['SC_Value'], label='SC Value PLSR')
        plt.plot([i for i in range(1, 11)], self.cv_rmse['ST_Value'], label='ST Value PLSR')
        plt.xlabel('Folds')
        plt.ylabel('RMSE')
